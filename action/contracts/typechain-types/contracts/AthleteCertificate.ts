...
export interface AthleteCertificateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "tokenIdByResultId",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export namespace CertificateMintedEvent {
  ...
  export type OutputTuple = [tokenId: bigint, resultId: bigint, to: string];
  export interface OutputObject {
    tokenId: bigint;
    resultId: bigint;
    to: string;
...
export interface AthleteCertificate extends BaseContract {
  connect(runner?: ContractRunner | null): AthleteCertificate;
  waitForDeployment(): Promise<this>;

  interface: AthleteCertificateInterface;
  ...
  setMinter: TypedContractMethod<[m: AddressLike], [void], "nonpayable">;
  ...
  tokenIdByResultId: TypedContractMethod<
    [arg0: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "tokenIdByResultId"
